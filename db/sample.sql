...
CREATE TABLE tastes (taste_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE pizzas (pizza_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE venues (venue_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
	name VARCHAR ( 50 ) NOT NULL,
...
CREATE TABLE venuePizzas (venue_pizza_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
